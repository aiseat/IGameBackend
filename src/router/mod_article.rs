...
pub async fn get_mod_article(
    ...
    let (s1, s2, s3, s4) = try_join4(
        client.prepare_typed_cached(
            "WITH t AS (
                SELECT a.id, array_agg(t.id) AS tag_ids, array_agg(t.value) AS tag_values, a.app_id, a.title, a.description, a.content, a.subscription, a.allowed_exp, a.horizontal_image, a.content_images, a.content_videos, a.content_video_thumbs, a.game_article_id, a.game_article_title, a.updated_at
            ...
            GROUP BY t.id, t.tag_ids, t.tag_values, t.app_id, t.title, t.description, t.content, t.subscription, t.allowed_exp, t.horizontal_image, t.content_images, t.content_videos, t.content_video_thumbs, t.game_article_id, t.game_article_title, t.updated_at",
            &[DBType::INT4]
        ), 
        client.prepare_typed_cached(
